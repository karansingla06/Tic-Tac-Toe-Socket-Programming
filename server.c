...
int check_move(char board[][3], int move, int player_id)
{
    if ((move == 9) || (board[move/3][move%3] == ' ')) { /* Move is valid. */
        ...
        // #ifdef DEBUG
        // if(player_id==0)
        //   printf("[DEBUG] TOTO move was valid.\n");
        // else if(player_id==1)
        //     printf("[DEBUG] TITI move was valid.\n");
        // #endif
       ...
       // #ifdef DEBUG
       // if(player_id==0)
       //   printf("[DEBUG] TOTO move was invalid.\n");
       // else if(player_id==1)
       //     printf("[DEBUG] TITI move was invalid.\n");
       // #endif
...
int main(int argc, char *argv[])
{
    ...
    while (1) {
        if (player_count <= 2) { /* Only launch a new game if we have room. Otherwise, just spin. */
